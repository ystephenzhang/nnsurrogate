...
echo "🚀 Starting Llama-3.2-3B-Instruct evaluation on GPU $GPU_ID"
...
# Update .env configuration for Llama-3.2-3B base model
echo "🔧 Updating .env configuration for Llama-3.2-3B-Instruct..."
...
MODEL_NAME="llama3.2_3b_base"
MODEL_DISPLAY_NAME="Llama-3.2-3B-Instruct (Base)"
...
# ========================================
echo ""
echo "🎉 LLAMA-3.2-3B-INSTRUCT EVALUATION COMPLETED SUCCESSFULLY!"
echo ""
...
echo ""
echo "🚀 Llama-3.2-3B-Instruct evaluation complete!"