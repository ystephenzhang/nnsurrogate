#!/bin/bash
# llama_1b_base_evaluation.sh
# Evaluation script for meta-llama/Llama-3.2-1B-Instruct (base model)
# Covers Heat_1D, Heat_steady_2D, and Burgers_1D tasks in both zero-shot and iterative settings
# Usage: ./llama_1b_base_evaluation.sh [GPU_ID]
...
echo "🚀 Starting Llama-3.2-1B-Instruct evaluation on GPU $GPU_ID"
...
RESUME_LOG="scripts/llama_1b_base_evaluation_progress.log"
touch "$RESUME_LOG"
...
# Update .env configuration for Llama-3.2-1B base model
echo "🔧 Updating .env configuration for Llama-3.2-1B-Instruct..."
...
MODEL_NAME="llama3.2_1b_base"
MODEL_DISPLAY_NAME="Llama-3.2-1B-Instruct (Base)"
...
# ========================================
echo ""
echo "🎉 LLAMA-3.2-1B-INSTRUCT EVALUATION COMPLETED SUCCESSFULLY!"
echo ""
...
echo ""
echo "🚀 Llama-3.2-1B-Instruct evaluation complete!"