./scripts/eval_template_new.sh O_openai euler_1d iterative medium
./scripts/eval_template_new.sh O_Qwen euler_1d iterative medium
./scripts/eval_template.sh O_Llama euler_1d iterative medium
